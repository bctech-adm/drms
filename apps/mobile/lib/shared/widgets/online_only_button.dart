...
class OnlineOnlyButton extends ConsumerWidget {
  const OnlineOnlyButton({super.key, required this.label, required this.onPressed, this.icon, this.danger = false, this.outlined = false});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final style = danger ? FilledButton.styleFrom(backgroundColor: scheme.error, foregroundColor: scheme.onError) : null;
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, mainAxisSize: MainAxisSize.min, children: [
      ...
      if (!online)
        Padding(
          ...
          child: Text(t.needsInternet, textAlign: TextAlign.center, style: TextStyle(color: scheme.error)),
        ),
    ]);
  }
}
